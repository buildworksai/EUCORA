...
class TestMinIOStorageCoverage:
    ...
    def test_upload_artifact_calculates_hash(self, mock_minio_class):
        ...
        object_path, artifact_hash = storage.upload_artifact(file_obj, "test-object", "application/octet-stream")
    ...
    def test_delete_artifact_removes_object(self, mock_minio_class):
        ...
        mock_client.remove_object.assert_called_once_with(storage.bucket_name, "test-object")
