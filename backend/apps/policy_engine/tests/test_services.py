...
class TestRiskScoring:
    ...
    def test_evaluate_vulnerability_severity_factor(self):
        ...
        assert _evaluate_factor("Vulnerability Severity", {"vulnerability_scan_results": {"critical": 1}}, {}) == 1.0

        # High vulnerabilities
        assert _evaluate_factor("Vulnerability Severity", {"vulnerability_scan_results": {"high": 1}}, {}) == 0.7

        # No vulnerabilities
        assert _evaluate_factor("Vulnerability Severity", {"vulnerability_scan_results": {}}, {}) == 0.0
