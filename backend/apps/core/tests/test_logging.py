...
class TestJSONLoggingFormat(TestCase):
    ...
    def test_json_logging_includes_correlation_id(self):
        ...
        test_logger.info("Test message", extra={"correlation_id": "test-123", "user_id": "user@test.com"})
...
class TestErrorSanitization(TestCase):
    ...
    def test_500_error_sanitizes_response(self):
        ...
        response = self.client.post(
            "/api/v1/auth/login/", data='{"invalid": json}', content_type="application/json"  # Malformed JSON
        )
    ...
    def test_error_response_includes_correlation_id(self):
        ...
        response = self.client.get("/api/v1/nonexistent/", HTTP_X_CORRELATION_ID="test-correlation-123")
