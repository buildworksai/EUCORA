...
deployment_total = Counter(
    'deployment_total',
    'Total deployments by status and ring',
    ['status', 'ring', 'app_name', 'requires_cab']
)
...
deployment_time_to_compliance_seconds = Gauge(
    'deployment_time_to_compliance_seconds',
    'Time from Ring 1 to compliance across all rings',
    ['ring', 'app_name']
)
...
ring_promotion_total = Counter(
    'ring_promotion_total',
    'Ring promotions by from_ring, to_ring, and status',
    ['from_ring', 'to_ring', 'status']
)

promotion_gate_success_rate = Gauge(
    'promotion_gate_success_rate',
    'Success rate for ring promotion gates',
    ['ring'],
)
