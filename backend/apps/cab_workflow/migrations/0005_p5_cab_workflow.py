    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(help_text="Correlation to deployment intent", max_length=255),
                ),
                (
                    "correlation_id",
                ...
                (
                    "evidence_package_id",
                    models.CharField(help_text="ID of associated evidence package", max_length=255),
                ),
                (
                    "risk_score",
                    models.DecimalField(
                        decimal_places=2, help_text="Risk score from evidence package (0-100)", max_digits=5
                    ),
                ),
                ...
                (
                    "approval_rationale",
                    models.TextField(blank=True, help_text="Reason for approval/rejection decision"),
                ),
                (
                    "approval_conditions",
                    models.JSONField(default=dict, help_text="Conditions if conditionally approved"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expires_at",
                    models.DateTimeField(help_text="Exception automatically expires (no permanent exceptions)"),
                ),
                (
                    "status",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cab_request_id",
                    models.CharField(help_text="ID of CABApprovalRequest being decided", max_length=255),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="cab_decisions_made",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
