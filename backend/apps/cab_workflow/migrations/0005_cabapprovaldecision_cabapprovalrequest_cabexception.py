# Generated by Django 5.0.14 on 2026-01-22 18:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ["-decided_at"],
                "indexes": [
                    models.Index(fields=["cab_request_id", "-decided_at"], name="cab_workflo_cab_req_387fdf_idx"),
                    models.Index(fields=["decision", "-decided_at"], name="cab_workflo_decisio_d9734f_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["deployment_intent_id", "-submitted_at"], name="cab_workflo_deploym_e21db2_idx"
                    ),
                    models.Index(fields=["status"], name="cab_workflo_status_748fd1_idx"),
                    models.Index(fields=["risk_score"], name="cab_workflo_risk_sc_b5c709_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["deployment_intent_id", "-requested_at"], name="cab_workflo_deploym_fc7365_idx"
                    ),
                    models.Index(fields=["status", "expires_at"], name="cab_workflo_status_ab15a7_idx"),
                ],
            },
        ),
    ]
