            ...
            try:
                asset, created_flag = Asset.objects.update_or_create(
                    ...
                    defaults={
                        ...
                        'location': asset_data.get('location', {}).get('name', '') if isinstance(asset_data.get('location'), dict) else asset_data.get('location', ''),
                        'owner': asset_data.get('assigned_on', {}).get('name', '') if isinstance(asset_data.get('assigned_on'), dict) else asset_data.get('assigned_on', ''),
