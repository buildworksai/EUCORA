...
class JiraServiceManagementService(IntegrationService):
                    ...
                    "content": [
                        {
                            ...
                            "content": [
                                {
                                    "type": "text",
                                    "text": self._build_issue_description(
                                        deployment_intent_id, evidence_pack, risk_score
                                    ),
                                }
                            ],
                        }
    ...
    def get_issue_status(self, system: ExternalSystem, issue_key: str) -> Dict[str, Any]:
    ...
    def _build_issue_description(
        self, deployment_intent_id: str, evidence_pack: Dict[str, Any], risk_score: int
    ) -> str:
