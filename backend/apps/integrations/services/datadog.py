...
class DatadogService(IntegrationService):
    ...
    def push_metric(
        self, system: ExternalSystem, metric_name: str, value: float, tags: List[str] = None
    ) -> Dict[str, Any]:
    ...
    def push_event(
        self, system: ExternalSystem, title: str, text: str, tags: List[str] = None, alert_type: str = "info"
    ) -> Dict[str, Any]:
