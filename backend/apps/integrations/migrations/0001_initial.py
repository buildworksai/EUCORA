    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("jira_assets", "Jira Assets"),
                            ("freshservice_cmdb", "Freshservice CMDB"),
                            ("servicenow_itsm", "ServiceNow ITSM"),
                            ("jira_service_management", "Jira Service Management"),
                            ("freshservice_itsm", "Freshservice ITSM"),
                            ...
                            ("grype", "Grype"),
                            ("snyk", "Snyk"),
                            ("defender_for_endpoint", "Microsoft Defender for Endpoint"),
                        ],
                        help_text="Type of external system",
                        max_length=50,
                    ),
                ),
                ...
                (
                    ...
                    models.IntegerField(default=60, help_text="How often to sync data from this system (in minutes)"),
                ),
                (
                    "last_sync_at",
                ...
                (
                    "metadata",
                    models.JSONField(
                        default=dict, help_text="System-specific configuration (field mappings, filters, etc.)"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sync_completed_at",
                    models.DateTimeField(blank=True, help_text="When the sync operation completed", null=True),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    "records_fetched",
                    models.IntegerField(default=0, help_text="Number of records fetched from external system"),
                ),
                (
                    "records_created",
                    models.IntegerField(default=0, help_text="Number of new records created in local database"),
                ),
                (
                    "records_updated",
                    models.IntegerField(default=0, help_text="Number of existing records updated in local database"),
                ),
                ...
                (
                    "system",
                    models.ForeignKey(
                        help_text="External system that was synced",
