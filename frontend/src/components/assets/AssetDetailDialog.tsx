            ...
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden flex flex-col glass p-0 border-white/20">
                ...
                <Tabs defaultValue="overview" className="flex-1 flex flex-col">
                    ...
                    <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
                                    ...
                                    <table className="w-full text-sm text-left">
                                        ...
                                        <tbody className="divide-y divide-border/50">
                                            {asset.installed_apps && asset.installed_apps.length > 0 ? (
                                                asset.installed_apps.map((app: { id: string; name: string; version: string; vendor: string }) => (
                        ...
                        <TabsContent value="troubleshoot" className="mt-0 p-6 bg-background/40 h-full min-h-0 flex flex-col overflow-hidden">
